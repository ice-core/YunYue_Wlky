...
public class SpxqActivity_test extends AppCompatActivity implements OnBannerListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        queue = Volley.newRequestQueue(SpxqActivity_test.this);
        pref = PreferenceManager.getDefaultSharedPreferences(SpxqActivity_test.this);
        ...
        ll_spxq_sp_ckqb.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(SpxqActivity_test.this, DpzyActivity.class);
        ...
        /*        Intent intent = new Intent(SpxqActivity.this, MainActivity.class);
                ...
                startActivity(intent);*/
                Intent intent = new Intent(SpxqActivity_test.this, GwcActivity.class);
                //  intent.putExtra("ID", "2");
                startActivity(intent);
            }
        });
        ...
        ll_spxq_xq_sxp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                tv_spxq_pj_sxp_bj.setBackgroundColor(ContextCompat.getColor(SpxqActivity_test.this, R.color.touming));
                tv_spxq_xq_sxp.setTextColor(tv_spxq_xq_sxp.getResources().getColor(R.color.theme));
                tv_spxq_xq_sxp_bj.setBackgroundColor(ContextCompat.getColor(SpxqActivity_test.this, R.color.theme));
    ...
    private void qbpl() {
        ...
        tv_spxq_pj_sxp_bj.setBackgroundColor(ContextCompat.getColor(SpxqActivity_test.this, R.color.theme));
        tv_spxq_xq_sxp.setTextColor(tv_spxq_xq_sxp.getResources().getColor(R.color.qian_hei));
        tv_spxq_xq_sxp_bj.setBackgroundColor(ContextCompat.getColor(SpxqActivity_test.this, R.color.touming));
    ...
    private void txdd() {
        ...
        map.put("ItemOriginal_Img", resultOriginal_Img);
        ...
        map.put("ItemSpec_Key_Name", tv_spxq_xzgg_dialog_name.getText().toString());
        txddGridData.mylist.add(map);
        mList.add(txddGridData);
        Intent intent = new Intent(SpxqActivity_test.this, TxddActivity.class);
        ...
        final JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject jsonObject) {
                ...
                try {
                    ...
                    int resultCode = jsonObject1.getInt("code");
                    if (resultCode > 0) {
                        Intent intent1 = new Intent(SpxqActivity_test.this, SpxqActivity_test.class);
            ...
            public void onResponse(JSONObject jsonObject) {
                ...
                try {
                    ...
                    if (resultCode > 0) {
                        if (is_shouchang == 0) {
                            is_shouchang = 1;
                            iv_spxq_spsc.setImageResource(R.drawable.icon_shoucang_selected);
    ...
    private void dialogin(String msg) {
        loadingDialog = new LoadingDialog(SpxqActivity_test.this, R.style.dialog, msg, LoadingDialog.WAITING_C);
        loadingDialog.show();
    }
    ...
    protected void Hint(String sHint, int type) {
        new HintDialog(SpxqActivity_test.this, R.style.dialog, sHint, type, true).show();
    }
  ...
  /*              String resultgoods_images_list = jsonObjectData.getString("goods_images_list");
                ...
                Glide.with(SpxqActivity_test.this)
               ...
               /* if (mylistXq.size() >= 1) {
                    Glide.with(SpxqActivity.this)
                            .load( Api.sUrl+ mylistXq.get(0).get("Item"))
                            .asBitmap()
                            .placeholder(R.mipmap.error)
                            .error(R.mipmap.error)
                            .dontAnimate()
                            .into(new SimpleTarget<Bitmap>() {
                                ...
                                public void onResourceReady(Bitmap resource, GlideAnimation<? super Bitmap> glideAnimation) {
                                    ...
                                    iv_spxq_xq_item.setImageBitmap(resource);
                                }
                            });
                }
                if (mylistXq.size() >= 2) {
                    Glide.with(SpxqActivity.this)
                            .load( Api.sUrl+ mylistXq.get(1).get("Item"))
                            .asBitmap()
                            .placeholder(R.mipmap.error)
                            .error(R.mipmap.error)
                            .dontAnimate()
                            .into(iv_spxq_xq_item1);
                }
                if (mylistXq.size() >= 3) {
                    Glide.with(SpxqActivity.this)
                            .load( Api.sUrl+ mylistXq.get(2).get("Item"))
                            .asBitmap()
                            .placeholder(R.mipmap.error)
                            .error(R.mipmap.error)
                            .dontAnimate()
                            .into(iv_spxq_xq_item2);
                }*/
                ArrayList<HashMap<String, String>> mylistgoodguige = new ArrayList<HashMap<String, String>>();
                JSONArray resultgoodguige = jsonObjectData.getJSONArray("goodguige");
    ...
    private void initialize() {
        dialog = new Dialog(SpxqActivity_test.this, R.style.ActionSheetDialogStyle);
        inflate = LayoutInflater.from(SpxqActivity_test.this).inflate(R.layout.spxq_xzgg_dialog, null);
        ...
        mgv_spxq_xzgg_dialog_xgg = inflate.findViewById(R.id.mgv_spxq_xzgg_dialog_xgg);
    ...
    private void initialize_cs() {
        dialog_cs = new Dialog(SpxqActivity_test.this, R.style.ActionSheetDialogStyle);
        final View inflate = LayoutInflater.from(SpxqActivity_test.this).inflate(R.layout.spxq_cs_dialog, null);
...
/*    *//**
    ...
    private void setGridViewXq(ArrayList<HashMap<String, String>> mylist) {
        ...
        mgv_spxq_xq.setAdapter(myAdapterXq);
        *//*sv_shouye.smoothScrollTo(0, 20);
        sv_shouye.setFocusable(true);*//*
        //setListViewHeightBasedOnChildren(mgv_spxq_xq);
     ...
     */
    private void setGridViewXq(ArrayList<HashMap<String, String>> mylist) {
        MyAdapterXq myAdapterXq = new MyAdapterXq(SpxqActivity_test.this);
        myAdapterXq.arrlist = mylist;
...
/*    public void setListViewHeightBasedOnChildren(ListView listView1) {
    ...
    private void setGridViewDptj(ArrayList<HashMap<String, String>> mylist) {
        MyAdapterDptj myAdapterDptj = new MyAdapterDptj(SpxqActivity_test.this);
...
*/
    ...
    private void setGridViewXgg(ArrayList<HashMap<String, String>> mylist) {
        myAdapterXgg = new MyAdapterXgg(SpxqActivity_test.this);
        myAdapterXgg.arrlist = mylist;

        mgv_spxq_xzgg_dialog_xgg.setAdapter(myAdapterXgg);
    }
