 ...
 * {@link DaifukuanFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link DaifukuanFragment#newInstance} factory method to
...
public class DaifukuanFragment extends Fragment {
    ...
    public static DaifukuanFragment newInstance(String param1, String param2) {
        DaifukuanFragment fragment = new DaifukuanFragment();
    ...
    private void huoqu(final int page) {
        String url = Api.sUrl + "Api/Order/orderlist/appId/" + Api.sApp_Id
                + "/user_id/" + sUser_id + "/state/1" + "/page/" + page;
