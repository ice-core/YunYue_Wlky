package com.example.administrator.yunyue.image;
    ...
    private static class ImageAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            if (view != null) {
                ...
                loading.setProgressDrawable(ContextCompat.getDrawable(context, R.color.blue_2bbbe6));
                ...
                Glide.with(context).load( imgurl).diskCacheStrategy(DiskCacheStrategy.ALL)//缓存多个尺寸
                        ...
                        .error(R.drawable.mis_default_error)//加载错误图片
                        .into(new GlideDrawableImageViewTarget(imageView) {
                            ...
                            public void onLoadStarted(Drawable placeholder) {
                               ...
                               /* if(smallImageView!=null){
                                    ...
                                    Glide.with(context).load( Api.sUrl+imgurl).into(smallImageView);
                                }*/
