 ...
 * {@link DaifaHuoFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link DaifaHuoFragment#newInstance} factory method to
...
public class DaifaHuoFragment extends Fragment {
    ...
    private GridView gv_wode_daifukuan;
    ...
    private PullToRefreshGridView pull_refresh_wode_daifukuan;
     ...
     * @return A new instance of fragment DaifukuanFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static DaifaHuoFragment newInstance(String param1, String param2) {
        DaifaHuoFragment fragment = new DaifaHuoFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_daifukuan, container, false);
    }
    ...
    public void onViewCreated(View view, Bundle saveInstancesState) {
        ...
        gv_wode_daifukuan = view.findViewById(R.id.gv_wode_daifukuan);
        pull_refresh_wode_daifukuan = view.findViewById(R.id.pull_refresh_wode_daifukuan);
        isViewCreated = true;
        ...
        pull_refresh_wode_daifukuan.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<GridView>() {
            // 下拉刷新加载
            @Override
    ...
    private void huoqu(final int page) {
        String url = Api.sUrl + "Api/Order/orderlist/appId/" + Api.sApp_Id
                + "/user_id/" + sUser_id + "/state/2" + "/page/" + page;
    ...
    private void gridviewdata() {
        ...
        pull_refresh_wode_daifukuan.setAdapter(myAdapter);
        // 刷新适配器
        myAdapter.notifyDataSetChanged();
        // 关闭刷新下拉
        pull_refresh_wode_daifukuan.onRefreshComplete();
    ...
    private void Delete(String order_id) {
        String url = Api.sUrl + "Order/orderList/user_id/" + sUser_id + "/order_id/" + order_id;
