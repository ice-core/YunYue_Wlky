...
public class XqActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_xq_h5);
        ...
        iv_xq_back = findViewById(R.id.iv_xq_back);
        iv_xq_back.setOnClickListener(new View.OnClickListener() {
            @Override
