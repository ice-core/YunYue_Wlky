...
public class Fjsc_WdddActivity extends AppCompatActivity implements Fjsc_WdddFragment.OnFragmentInteractionListener {
    ...
    private void setGridView() {
        myAdapter = new MyAdapter(Fjsc_WdddActivity.this);
    ...
    private class MyAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View view, ViewGroup arg2) {
            ...
            if (iPositionId == Integer.valueOf(arrlist.get(position).get("ItemId"))) {
                ...
                zx_fl_item.setBackgroundColor(ContextCompat.getColor(Fjsc_WdddActivity.this, R.color.theme));
            } else {
                zx_fl_item_name.setTextColor(zx_fl_item_name.getResources().getColor(R.color.hui999999));
                zx_fl_item.setBackgroundColor(ContextCompat.getColor(Fjsc_WdddActivity.this, R.color.touming));
            }
    ...
    private void initFragment() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            Fjsc_WdddFragment fjsc_wdddFragment = new Fjsc_WdddFragment();
            fragments.add(fjsc_wdddFragment);
        }
