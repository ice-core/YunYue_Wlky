...
public class Zb_GzActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ll_zb_gz_back = findViewById(R.id.ll_zb_gz_back);
        ll_zb_gz_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                finish();
            }
        });
        gv_zb_gz = findViewById(R.id.gv_zb_gz);
        setGridView();
    }
    ...
    private void setGridView() {
        MyAdapter myAdapter = new MyAdapter(Zb_GzActivity.this);
