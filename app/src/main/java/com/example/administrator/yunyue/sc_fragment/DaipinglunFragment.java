 ...
 * {@link DaipinglunFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link DaipinglunFragment#newInstance} factory method to
...
public class DaipinglunFragment extends Fragment {
     ...
     * @return A new instance of fragment DaipinglunFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static DaipinglunFragment newInstance(String param1, String param2) {
        DaipinglunFragment fragment = new DaipinglunFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_daipinglun, container, false);
    }
    ...
    public void onViewCreated(View view, Bundle saveInstancesState) {
        ...
        gv_wode_daipinglun = view.findViewById(R.id.gv_wode_daipinglun);
        pull_refresh_wode_daipinglun = view.findViewById(R.id.pull_refresh_wode_daipinglun);
        isViewCreated = true;
        ...
        iPage = 1;
        lazyLoad();
        pull_refresh_wode_daipinglun.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<GridView>() {
            // 下拉刷新加载
            @Override
    ...
    private void huoqu(final int page) {
        String url = Api.sUrl + "Api/Order/orderlist/appId/" + Api.sApp_Id
                + "/user_id/" + sUser_id + "/state/4" + "/page/" + page;
    ...
    private void gridviewdata() {
        ...
        pull_refresh_wode_daipinglun.setAdapter(myAdapter);
        // 刷新适配器
        myAdapter.notifyDataSetChanged();
        // 关闭刷新下拉
        pull_refresh_wode_daipinglun.onRefreshComplete();
