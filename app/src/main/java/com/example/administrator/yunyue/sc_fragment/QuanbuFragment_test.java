 ...
 * {@link QuanbuFragment_test.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link QuanbuFragment_test#newInstance} factory method to
 * create an instance of this fragment.
 */
public class QuanbuFragment_test extends Fragment {
     ...
     * @return A new instance of fragment QuanbuFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static QuanbuFragment_test newInstance(String param1, String param2) {
        QuanbuFragment_test fragment = new QuanbuFragment_test();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_quanbu_test, container, false);
    }
    ...
    public void onViewCreated(View view, Bundle saveInstancesState) {
        ...
        pull_refresh_wode_quanbu = view.findViewById(R.id.pull_refresh_wode_quanbu);
    ...
    private void huoqu(final int page) {
        String url = Api.sUrl + "Api/Order/orderlist/appId/" + Api.sApp_Id
                + "/user_id/" + sUser_id + "/state/" + Sc_WdddActivity.iPosition + "/page/" + page;
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject jsonObject) {
                hideDialogin();
