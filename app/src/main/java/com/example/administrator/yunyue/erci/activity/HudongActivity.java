...
public class HudongActivity extends AppCompatActivity {
    private static final String TAG = HudongActivity.class.getSimpleName();
    /**
     * 返回
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pref = PreferenceManager.getDefaultSharedPreferences(HudongActivity.this);
        ...
        tv_jikangyu_ftz.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    Intent intent = new Intent(HudongActivity.this, FabutieziActivity.class);
        ...
        tv_jikangyu_fgy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    Intent intent = new Intent(HudongActivity.this, FabukyxqActivity.class);
                    startActivity(intent);
                    gone();
    ...
    private void setGridView() {
        myAdapter = new MyAdapter(HudongActivity.this);
        ...
        gv_jky_hint.setNumColumns(tab.length);
    ...
    private class MyAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View view, ViewGroup arg2) {
            ...
            if (iPosition == Integer.valueOf(arrlist.get(position).get("ItemId"))) {
                ...
                zx_fl_item.setBackgroundColor(ContextCompat.getColor(HudongActivity.this, R.color.theme));
            } else {
                zx_fl_item_name.setTextColor(zx_fl_item_name.getResources().getColor(R.color.hui999999));
                zx_fl_item.setBackgroundColor(ContextCompat.getColor(HudongActivity.this, R.color.touming));
            }
    ...
    private void Rv_data(ArrayList<HashMap<String, String>> mylist, List<JkyTzData> mList) {
        recycleAdapterDome = new RecycleAdapterDome(HudongActivity.this, mylist, mList);
        recycleAdapterDome.setHasStableIds(true);
        rv_jky_lb.setAdapter(recycleAdapterDome);
        LinearLayoutManager manager = new LinearLayoutManager(HudongActivity.this);
    ...
    public class RecycleAdapterDome extends RecyclerView.Adapter<RecycleAdapterDome.MyViewHolder> {
        ...
        public void onBindViewHolder(RecycleAdapterDome.MyViewHolder holder, int position) {
            ...
            if (iPosition == 0) {
                ...
                Glide.with(HudongActivity.this)
                ...
                holder.ll_jky_kyxq_item.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(HudongActivity.this, KyxqXqActivity.class);
    ...
    private void dialogin(String msg) {
        loadingDialog = new LoadingDialog(HudongActivity.this, R.style.dialog, msg, LoadingDialog.WAITING_C);
        loadingDialog.show();
    }
    ...
    protected void Hint(String sHint, int type) {
        new HintDialog(HudongActivity.this, R.style.dialog, sHint, type, true).show();
    }
