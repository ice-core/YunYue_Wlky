 ...
 * Use the {@link Shouye_TwoFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Shouye_TwoFragment extends Fragment {
    ...
    @BindView(R.id.ll_shouye_two_query)
    LinearLayout llShouyeTwoQuery;
    @BindView(R.id.gv_lb_x_tu)
    GridView gvLbXTu;
    @BindView(R.id.ll_shouye_qbdd)
    LinearLayout llShouyeQbdd;
    @BindView(R.id.ll_shouye_hbkj)
    LinearLayout llShouyeHbkj;
    @BindView(R.id.ll_shouye_wdsc)
    LinearLayout llShouyeWdsc;
    @BindView(R.id.ll_shouye_bzyfk)
    LinearLayout llShouyeBzyfk;
    @BindView(R.id.ll_shouye_xsms)
    LinearLayout llShouyeXsms;
    @BindView(R.id.ll_shouye_zhibo)
    LinearLayout llShouyeZhibo;
    @BindView(R.id.gv_tu)
    GridView gvTu;
    @BindView(R.id.iv_shouye_two_guanggao)
    ImageView ivShouyeTwoGuanggao;
    @BindView(R.id.cav_shouye_zhixun)
    CardView cavShouyeZhixun;
    @BindView(R.id.tv_shouye_two_count)
    TextView tvShouyeTwoCount;
    @BindView(R.id.mgv_shouye_zixun)
    MyGridView mgvShouyeZixun;
    @BindView(R.id.sv_shouye)
    ObservableScrollView svShouye;
    ...
    private String[] banner = {"附近商城", "新闻资讯", "商家入驻"};
    ...
    public static Shouye_TwoFragment newInstance(String param1, String param2) {
        Shouye_TwoFragment fragment = new Shouye_TwoFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_shouye_two, container, false);
    ...
    @OnClick({R.id.ll_shouye_two_query, R.id.ll_shouye_qbdd, R.id.ll_shouye_hbkj, R.id.ll_shouye_wdsc, R.id.ll_shouye_bzyfk, R.id.ll_shouye_xsms})
    public void onViewClicked(View view) {
        Intent intent;
        switch (view.getId()) {
            case R.id.ll_shouye_two_query:
                intent = new Intent(getActivity(), SplbActivity.class);
                intent.putExtra("", "shangcheng");
                startActivity(intent);
                break;
            case R.id.ll_shouye_qbdd:
                intent = new Intent(getActivity(), WdddActivity.class);
                intent.putExtra("id", "0");
                startActivity(intent);
                break;
            case R.id.ll_shouye_hbkj:
                intent = new Intent(getActivity(), HbkjActivity.class);
                startActivity(intent);
                break;
            case R.id.ll_shouye_wdsc:
                intent = new Intent(getActivity(), ShoucangActivity.class);
                startActivity(intent);
                break;
            case R.id.ll_shouye_bzyfk:
                intent = new Intent(getActivity(), YjfkActivity.class);
                startActivity(intent);
                break;
            case R.id.ll_shouye_xsms:
                intent = new Intent(getActivity(), XsmsActivity.class);
                startActivity(intent);
                break;
        }
    }
